/**
Bybit Futures WebSocket Session v2
...
void WebSocketSession::onSSLHandshake(const boost::beast::error_code& ec) {
    ...
    m_ws.async_handshake(m_host, "/realtime_public",
